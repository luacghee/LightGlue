...
class LightGlue_custom(nn.Module):
    default_conf = {
        ...
        "filter_threshold": 0.2,  # match threshold
        "weights": "/home/lchonggh/LightGlue/model/basis/checkpoint_best.tar",
        # "weights": None,
    }
    ...
    def __init__(self, features="superpoint", **conf) -> None:
        ...
        state_dict = torch.load("/home/lchonggh/LightGlue/model/custom1/checkpoint_best.tar", map_location="cpu")
